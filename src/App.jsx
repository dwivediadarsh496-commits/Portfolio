...
const PROJECTS = [
  ...
  },
  {
    ...
    color: "#4FC3F7",
    icon: "🎙️",
    github: "https://github.com/dwivediadarsh496-commits/Jarvis-AI-Assistant",
    live: "https://jarvis-ai-tuo9.onrender.com/",
  ...
  return (
    <>
      ...
      <section id="certifications" style={{ padding: "20px 1.5rem 100px", maxWidth: 1100, margin: "0 auto" }}>
        ...
        <AnimSection delay={CERTS.length * 80}>
          <div style={{ display: "flex", justifyContent: "center", marginTop: 48 }}>
            <a
              href="https://drive.google.com/drive/folders/13bujtjDFtoojrVCk06K6tq3K06DO7o17"
              target="_blank"
              ...
              onMouseOver={e => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 30px rgba(108,99,255,0.35)";
              }}
              onMouseOut={e => {
            ...
            >
              <svg viewBox="0 0 87.3 78" style={{ width: 22, height: 20 }} xmlns="http://www.w3.org/2000/svg">
